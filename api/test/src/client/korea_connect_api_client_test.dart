...
void main() {
  ...
  group('KoreaConnectApiClient', () {
    late http.Client httpClient;
    late KoreaConnectApiClient apiClient;
    ...
    setUp(() {
      ...
      apiClient = KoreaConnectApiClient(
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = KoreaConnectApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => KoreaConnectApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = KoreaConnectApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws KoreaConnectApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<KoreaConnectApiMalformedResponse>()),
        );
      });

      test(
          'throws KoreaConnectApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<KoreaConnectApiRequestFailure>()
